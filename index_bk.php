            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="welcome_docmed_info">
                        ...
                        <ul>
                            <li> <a href="about.php"><b style="color:#fff">Vision</b> </a></li>
                            <li> <a href="about.php"><b style="color:#fff">Mission Statement</b> </a>
                            </li>
                ...
                <div class="col-lg-12">
                    <div class="card-grid">
                        <a class="leadercard wow fadeInLeftBig" href="niot_minister.php">
                            <div class="card__background" style="background-image:url(img/leaders/minister.jpg)">
                ...
                <div class="row text-center">
                        ...
                        <div class="documentcard wow fadeInLeftBig">
                            ...
                            <div class="face face2">
                                <div class="content">
                                    ...
                                    <p>This is where I network and build my professional protfolio.</p>
                                    <!-- <p>This is where I network and build my professional protfolio.</p> -->
                                    <a href="pressrelease_details.php" class="publicinside-page__btn publicinside-page__btn--city" style="">View Details</a>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="documentcard">
                            ...
                            <div class="face face2">
                                <div class="content">
                                    <u1 style="text-align:start;display: block;position:relative">
                                        <li><a href="press.php">Technology Licensing Agreements Signed with Indian Industries</a></li>
                                        <li><a href="#">Technologies Available for Transfer</a></li>
                                        <li><a href="#">IPR Details</a></li>
                                    </u1>
                                    <!-- <p>Technology Licensing Agreements Signed with Indian Industries</p>
                                    <p>Technologies Available for Transfer</p>
                                    <p>IPR Details</p> -->
                                </div>
                            </div>
                        </div>
