...
<body>
    ...
    $get_year = "select date_part('year', announce_dt) from mst_newsannouncement_$currentLang where date_part('year', announce_dt) <> $currentyear group by announce_dt" ;
    //    echo $get_year;
    //    exit;
        ...
        <div class="container table_container">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3></h3>
                        <p><a href="index.php"><i class="fa fa-home "> </i> /</a> Publications <a href="announce_details.php"> / News Announcement </a> / Archive </p>
                    </div>
                </div>
                <!-- </div> -->
            ...
            <div class="data-tables ">
                <h3 class="text-center wow zoomIn table_head"><strong>News Announcement (Archive)</strong></h3>
