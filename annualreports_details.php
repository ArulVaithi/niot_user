...
<body>
    ...
    $draftEn = "SELECT * FROM mst_annualreports_$currentLang WHERE  status='L' and date_part('year', announce_dt) = $currentyear ORDER BY announce_dt desc";
        ...
        <div class="container table_container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3></h3>
                        <p><a href="index.php"><i class="fa fa-home "> </i> /</a> Publications / Annual Reports</p>
                    </div>
                </div>
            </div>
            <!-- <div class="row"> -->
            <div class="data-tables ">
                <h3 class="text-center wow zoomIn table_head"><strong>Annual Reports</strong></h3>
                <hr class="hr_align">
                <!-- <div class="col-lg-2"> -->
                <div class="row table_row">
                    ...
                    <div class="col-lg-2">
                        <a href="annualreports_archive.php" class="btn btn-success button pull-right" style="margin-left:10px;color:#fff"><i class="fa fa-archive" aria-hidden="true"></i> Archive </a>
                    </div>
                </div>
