...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="bradcam_text">
                    <h3></h3>
                    <p><a href="index.php"><i class="fa fa-home "> </i> /</a> Contact Us / NIOT, Chennai</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section id="work-process" class="work-process">
        <div class="container customstyle">
            <div class=" wow zoomIn" data-aos="fade-up">
                <h2 class="text-center contenttitle">Contact Us</h2>
            </div>
            ...
            <div class="row ">
                ...
                <div class="col-md-12  wow fadeInRight" data-aos="fade-left">
                    <!-- <h3>Vision</h3> -->
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="bg-white border border-top-0 p-4 mb-3">
                                    <div class="mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <p class="m-0">The Director, <br>National Institute Of Ocean Technology,<br> Velacherry-Tambaram Main Road, Narayanapuram,<br> Pallikaranai, Chennai - 600 100, Tamil Nadu, INDIA.</p>
                                        </div>
                                        <div class="mb-3">
                                            <div class="d-flex align-items-center mb-2">
                                            ...
                                            <p class="m-0">postmaster@niot.res.in</p>
                                        </div>
                                        <div class="mb-3">
                                            <div class="d-flex align-items-center mb-2">
                                            ...
                                            <p class="m-0">044-66783300</p>
                                        </div>
                                        <div class="mb-3">
                                            <div class="d-flex align-items-center mb-2">
                                                <i class="fa fa-fax text-primary mr-2"></i>
                                                <h5 class="font-weight-bold mb-0">Fax</h5>
                                            </div>
                                            <p class="m-0">044-22460275/22460645</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="bg-white border border-top-0 p-3">
                                        <a href="" class="d-block w-100 text-white text-decoration-none mb-3" style="background: #39569E;">
                                            <i class="fa fa-facebook-f text-center py-4 mr-3" style="width: 65px; background: rgba(0, 0, 0, .2);"></i>
                                            <span class="font-weight-medium">12,345 Fans</span>
                                        </a>
                                        <a href="" class="d-block w-100 text-white text-decoration-none mb-3" style="background: #52AAF4;">
                                            <i class="fa fa-twitter text-center py-4 mr-3" style="width: 65px; background: rgba(0, 0, 0, .2);"></i>
                                            <span class="font-weight-medium">12,345 Followers</span>
                                        </a>
                                        <a href="" class="d-block w-100 text-white text-decoration-none mb-3" style="background: #0185AE;">
                                            <i class="fa fa-linkedin-in text-center py-4 mr-3" style="width: 65px; background: rgba(0, 0, 0, .2);"></i>
                                        ...
                                        <a href="" class="d-block w-100 text-white text-decoration-none mb-3" style="background: #DC472E;">
                                            <i class="fa fa-youtube text-center py-4 mr-3" style="width: 65px; background: rgba(0, 0, 0, .2);"></i>
