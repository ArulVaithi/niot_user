...
<body>
    ...
    $draftEn = "SELECT * FROM mst_newsannouncement_$currentLang WHERE  status='L' and date_part('year', announce_dt) = $currentyear ORDER BY announce_dt desc";
        ...
        <div class="container table_container">
            ...
            <div class="data-tables ">
                ...
                <div class="row table_row">
                    ...
                    <div class="col-lg-2">
                        <a href="announcement_archive.php" class="btn btn-success button pull-right" style="margin-left:10px;color:#fff"><i class="fa fa-archive" aria-hidden="true"></i> Archive </a>
                    </div>
                </div>
