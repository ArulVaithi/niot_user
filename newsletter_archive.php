...
<body>
    ...
    $get_year = "select date_part('year', announce_dt) from mst_newsletter_$currentLang where date_part('year', announce_dt) <> $currentyear group by announce_dt";
    //    echo $get_year;
    //    exit;
    ...
    <section>
        <div class="container table_container">
            ...
            <div class="data-tables ">
                <h3 class="text-center wow zoomIn table_head"><strong>News Letter (Archive)</strong></h3>
