        ...
        <div class="container table_container">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3></h3>
                        <p><a href="index.php"><i class="fa fa-home "> </i> /</a> Publications <a href="pressrelease_details.php"> / Press Release </a> / Archive</p>
                    </div>
                </div>
                <!-- </div> -->
            ...
            <div class="data-tables ">
                <h3 class="text-center wow zoomIn table_head"><strong>Press Release (Archive)</strong></h3>
