    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="bradcam_text">
                    <h3></h3>
                    <p><a href="index.php"><i class="fa fa-home "> </i> /</a> Who's Who / Former Director</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section id="work-process" class="work-process">
        <div class="container customstyle">
            <div class="section-title wow zoomIn" data-aos="fade-up">
                <h2 class="text-center contenttitle">Prof.M.Ravindran [09-11-1993 - 31-05-2004]</h2>
            ...
            <div class="row content">
                ...
                <div class="col-lg-4 wow fadeInLeft">
                    <div class="row" style="background-color:#041e42;border-radius: 20px;">
                        <div class="row whoswhostyle">
                            <img src="assets/images/leaders/former directors/former_director1a.jpg" alt="Union Minister, MoES" class="whoswhoimg">
                        </div>
                ...
                <div class="col-lg-8  wow fadeInRight" data-aos="fade-left">
                    ...
                    <!-- <h3>Vision</h3> -->
                    <?php
                    $draftEn = "select * FROM niot_whoswho_$currentLang where designation = 'niot_minister' and status='A' and contents <> '' limit 1";
                    // echo  $draftEn;
