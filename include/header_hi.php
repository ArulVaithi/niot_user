        ...
        <div id="sticky-header" class="main-header-area">
            ...
            <div class="row mainheader-border">
                ...
                <div class="col-xl-7 col-lg-7 col-md-12">
                    <div class="logotext_hi">
                        <a href="index.php">
                            <h5><strong>राष्ट्रीय समुद्र प्रौद्योगिकी संस्थान </strong>
                            </h5>
                            <!-- </br>
                            </br> -->
                            <p>पृथ्वी विज्ञान मंत्रालय, भारत सरकार</p>
                        </a>
                    </div>
                </div>
                        ...
                        <nav>
                            <ul id="navigation" class="nobulletstyle">
                                ...
                                <li><a href="#">कौन क्या है <i class="ti-angle-down"></i></a>
                                    <ul class="submenu">
                                        <li><a href="niot_minister.php">केंद्रीय मंत्री, एमओईएस</a></li>
                                        <li><a href="niot_secretary.php">सचिव, एमओईएस</a></li>
                                        <li><a href="niot_director.php">निदेशक, एनआईओटी</a></li>
                                ...
                                <li><a href="#">दस्तावेज / प्रकाशन<i class="ti-angle-down"></i></a>
                                    <ul class="submenu">
                                        <li><a href="pressrelease_details.php">प्रेस विज्ञप्ति</a></li>
                                        <li><a href="announce_details.php">समाचार / घोषणाएं</a></li>
                                        <li><a href="annualreports_details.php">वार्षिक रिपोर्ट</a></li>
                                        <li><a href="newsletter_details.php">सूचनापत्र</a></li>
                                ...
                                <li><a href="#">भर्ती <i class="ti-angle-down"></i></a>
                                    <ul class="submenu">
                                        <li><a href="recruitment_details.php">वर्तमान रिक्तियां</a></li>
                                ...
                                <li><a href="#">मीडिया <i class="ti-angle-down"></i></a>
                                    <ul class="submenu">
                                        <li><a href="events_gallery.php">घटना गैलरी</a></li>
