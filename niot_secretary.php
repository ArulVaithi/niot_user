    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="bradcam_text">
                    <h3></h3>
                    <p><a href="index.php"><i class="fa fa-home "> </i> /</a> Who's Who / Secretary, MoES</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section id="work-process" class="work-process">
        <div class="container customstyle">
            <div class="section-title wow zoomIn" data-aos="fade-up">
                <h2 class="text-center contenttitle">Secretary, MoES</h2>
            ...
            <div class="row content">
                ...
                <div class="col-lg-4 wow fadeInLeft">
                    <div class="row" style="background-color:#041e42;border-radius: 20px;">
                        <div class="row whoswhostyle">
                            <img src="img/leaders/leader2.jpg" alt="Union Minister, MoES" class="whoswhoimg">
                        </div>
                        <div class="row whostitle">
							  ...
							  <div class="col-lg-8">Secretary</div>
							  <div class="col-lg-2"></div>
							  </div>
                            ...
                            <!-- <span style="color:#fff;padding-left:20px;">Secretary, Ministry of Earth Sciences (MoES)</span> -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-8  wow fadeInRight" data-aos="fade-left">
                    ...
                    <!-- <h3>Vision</h3> -->
                    <?php
                    $draftEn = "select * FROM mst_whoswho_$currentLang where designation = 'niot_secretary' and status='A' and contents <> '' limit 1";
                    // echo  $draftEn;
